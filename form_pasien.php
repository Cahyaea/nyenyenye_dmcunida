                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                           ...
                           <form action="pasien_proses.php" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="validationServerUsername" name="fullname" placeholder="Masukkan Nama Lengkap" required>
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control" id="validationServerUsername" name="nickname" placeholder="Masukkan Nama Panggilan" required>
                                </div>
                                
                                <div class="form-group">
                                    <input type="text" class="form-control" id="validationServerUsername" name="born" placeholder="Masukkan TTL" required>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control" id="validationServerUsername" name="email" placeholder="Masukkan Email" required>
                                </div>

                                <div class="form-group">
                                    <input type="number" class="form-control" id="validationServerUsername" name="phonenumber" placeholder="Masukkan No Telp" required>
                                </div>
