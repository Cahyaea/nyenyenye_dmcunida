                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="tambah_rujukan.php" class="btn btn-primary btn-sm active" role="button" aria-pressed="true">Tambah Data</a>
                                <br> <br>
                                    <table class="table table-striped table-bordered first table-hover">
                                        ...
                                        <tbody>
                                                    ...
                                                    $query  = "SELECT * FROM rujukan ORDER BY id";
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td><?php echo $r['tanggalperiksa']?></td>     
                                                      <td><?php echo $r['tanggalpulang']?></td>     
