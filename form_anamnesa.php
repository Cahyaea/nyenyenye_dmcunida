            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Anamnesa Pasien</h5>
                            <div class="card-body">
                            <div class="table-responsive">
                            <form action="update_anamnesa_proses.php" method="post">
                                ...
                                <div class="form-group">
                                <label for="berat">Tanggal Periksa:</label><br>
                                    <input type="date" class="form-control" id="validationServerUsername" name="tanggalperiksa" placeholder="Masukkan Tanggal Periksa" required>
                                </div>

                                <div class="form-group">
                                <label for="berat">Tanggal Pulang:</label><br>
                                    <input type="date" class="form-control" id="validationServerUsername" name="tanggalpulang" placeholder="Masukkan Tanggal Pulang" >
                                </div>

                                <div class="form-group">
                                <label for="berat">Berat Badan:</label><br>
                                    <input type="text" class="form-control" id="validationServerUsername" name="berat" placeholder="Masukkan Berat Badan" required>
                                </div>

                                <div class="form-group">
                                <label for="tinggi">Tinggi Badan:</label><br>
                                    <input type="text" class="form-control" id="validationServerUsername" name="tinggi" placeholder="Masukkan Tinggi Badan" required>
                                </div>

                                <div class="form-group">
                                <label for="suhu">Suhu Badan:</label><br>
                                    <input type="text" class="form-control" id="validationServerUsername" name="suhu" placeholder="Masukkan Suhu Badan" required>
                                </div>

                                <div class="form-group">
                                <label for="detak_jantung">Detak Jantung:</label><br>
                                    <input type="text" class="form-control" id="validationServerUsername" name="detak_jantung" placeholder="Masukkan Detak Jantung" required>
                                </div>

                                <div class="form-group">
                                <label for="tensi_darah">Tensi Darah:</label><br>
                                    <input type="text" class="form-control" id="validationServerUsername" name="tensi_darah" placeholder="Masukkan Tensi Darah" required>
                                </div>

                                <div class="form-group">
                                <label for="riwayat_penyakit">Riwayat Penyakit:</label><br>
                                    <input type="text" class="form-control" id="validationServerUsername" name="riwayat_penyakit" placeholder="Masukkan Riwayat Penyakit" required>
                                </div>
