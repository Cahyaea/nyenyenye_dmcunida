<?php
  include_once('koneksi.php');
    $id = $_GET['id'];
    $data = mysqli_query($connect, "SELECT * from rujukan where id='$id'"); 
            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Rujukan</h5>
                            <div class="card-body">
                            <div class="table-responsive">
                            <form action="update_rujukan_proses.php" method="post">
                                
                                <div class="form-group" >
                                    <input type="number" class="form-control" id="validationServerUsername" name="id" value="<?php echo $r['id']; ?>" readonly placeholder="Masukkan ID" required>
                                </div>
                                ...
                                <label for="keluhan">Keluhan pasien saat ini:</label><br>
                                    <input type="text" class="form-control" id="validationServerUsername" name="keluhan" value="<?php echo $r['keluhan']; ?>" placeholder="Apa Keluhan Anda?" required>
                                </div>
