<?php
  include_once('koneksi.php');
    ...
    $data = mysqli_query($connect, "SELECT d.*, a.*, r.*, g.*, m.* from data_pasien as d, anamnese as a, registrasi as r, diagnosa_pasien as g, m_icd10 as m WHERE id_pasien='$id_pasien' AND d.id_pasien=r.no_rm AND a.id=r.id_anamnese AND r.id=g.registrasi_id AND m.kode=g.code_icd10"); 
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <form action="update_tindakan_proses.php" method="POST">
                                ...
                                <input type="text" class="form-control" id="validationServerUsername" name="m_icd10" value="<?php echo $r['deskripsi']; ?>" readonly placeholder="Masukkan Nama Lengkap" required>
                                </div>

                                <?php
                                    include_once('koneksi.php');
                                    
                                    $d = mysqli_query($connect, "SELECT * FROM m_icd9 ORDER BY description ASC"); 
                                    // $r = mysqli_fetch_array($data);

                                ?>

                                <div class="form-group" id="validationServerUsername">
                                <label for="suhu">Tindakan untuk pasien:</label><br>
                                    <select class="form-control" id="validationServerUsername" name="m_icd9" required>
                                ...
                                <div class="form-group" id="validationServerUsername">
                                <label for="suhu">Rujukan untuk pasien:</label><br>
                                    <select class="form-control" id="validationServerUsername" name="rujukan" required>
                                        <option>Rujuk Rawat Jalan</option>
                                        <option>Rujuk Rawat Inap</option>
                                        <option>Rujuk RS Lain</option>
                                    </select>
                                </div>
