                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="form_penyakit.php" class="btn btn-primary btn-sm active" role="button" aria-pressed="true">Tambah Data</a>
                                <br> <br>
                                    <table class="table table-striped table-bordered first table-hover">
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        <a href="update.php?id=<?php echo $r['id']; ?>" class="btn btn-info btn-sm">Edit</a>
                                                        </button>
