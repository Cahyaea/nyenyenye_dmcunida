...
<head>
    ...
    <title>Admin | Form Penyakit</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                           ...
                           <form action="buat_diagnosa.php" method="post">
                                <div class="form-group" >
                                    <input type="text" class="form-control" id="validationServerUsername" name="nama_kategori" placeholder="Masukkan Diagnosa" required>
                                </div>
