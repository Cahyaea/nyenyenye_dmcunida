    ...
    <div class="dashboard-main-wrapper">
        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            ...
            <div class="container">
                <img src="img/dmc.png" width="10%" alt="">
       ...
       <div class="nav-left-sidebar sidebar-dark">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fas fa-address-card"></i>Anamnesa</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="dashboard-wrapper">
            ...
            <h4 class="text-center title-login font-weight-bold">Darussalam Medical Center (DMC)</h4>
            <br>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2020 Darussalam Medical Center | UNIDA Gontor
                        </div>
                    </div>
                </div>
            </div>
